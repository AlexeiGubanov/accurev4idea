...
public class AccuRevVcs extends AbstractVcs
  implements ProjectComponent, EditFileProvider, TransactionProvider, StandardOperationsProvider {
    ...
    public static AccuRevVcs getInstance(Project project) {
        return (AccuRevVcs) project.getComponent(AccuRevVcs.class);
    }
    ...
    public void start() throws VcsException {
        ...
        fileViewEnvironment = new LvcsFileViewEnvironment(myProject);
        upToDateRevisionProvider = new AccuRevUpToDateRevisionsProvider(this);
