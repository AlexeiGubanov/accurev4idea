...
/**
 * The add command deletes (defuncts) a given file or directory to accurev repository
 *
 * @author Igor Fedulov <a href="mailto:igor@fedulov.com>igor@fedulov.com</a>
 * @since   1.0
 * @version 1.0
 */
public class DefunctCommand extends BaseAccurevCommand implements Command {
    private final List args = new LinkedList() {{
        add(AccuRevArguments.DEFUNCT);
    }};

    public DefunctCommand(File file) {
