...
class AccuRevFileStatusCache {
    ...
    synchronized void refreshCache() {
        ...
        List workspaces = new ArrayList(); //TODO getProjectModuleContentRoots(vcs.getProject());
...
//        Module modules[] = ProjectLevelVcsManager.getInstance(project).getAllModulesUnder(vcs); //TODO
